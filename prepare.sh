...
source_dir_to_target_dir_map["../../demo-intellij"]="intellij"
...
# source_dir_to_target_dir_map["../../demo-future"]="future"
...
# source_dir_to_target_dir_map["../../demo-typora"]="typora"
...
# source_dir_to_target_dir_map["../../captcha"]="captcha"
# source_dir_to_target_dir_map["../../demo-ffmpeg"]="ffmpeg"
# source_dir_to_target_dir_map["../../demo-kvm"]="kvm"
# source_dir_to_target_dir_map["../../demo-ai"]="ai"

# 删除 docs 下除 .vitepress 外的所有目录（保留 docs/.vitepress 和 docs/index.md）
for dir in docs/*/; do
    [ -d "$dir" ] || continue
    dir_name=$(basename "$dir")
    if [ "$dir_name" != ".vitepress" ]; then
        rm -rf "docs/$dir_name"
    fi
done
